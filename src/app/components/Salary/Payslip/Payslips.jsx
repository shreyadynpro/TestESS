...
const Payslips = () => {
  ...
  const handleMonthChange = (event) => {
    ...
    fetchPayslipData(selectedMonth);
  };
      ...
      <Box position="relative" mb={4}>
        ...
        >
          ...
          <Box display="flex" alignItems="center">
            <FormControl
              sx={{
                minWidth: 200, // Expanded width
                height: '40px', // Set height of the FormControl, affects label positioning
                mr: 2,
                '& .MuiInputBase-root': {
                  height: '100%', // Ensures Select input height matches FormControl height
                ...
                '& .MuiSelect-select': {
                  paddingTop: '10px', // Adjust padding to vertically align the text
                  paddingBottom: '10px',
                },
              }}
            >
              ...
              <Select
                ...
                MenuProps={{
                  PaperProps: {
                    style: {
                      maxHeight: 200, // Set max height of the dropdown
                      width: 200, // Width of the dropdown list
                    },
                  },
                }}
              >
            ...
            <button
              ...
              onMouseOut={(e) => (e.currentTarget.style.backgroundColor = '#123375')}
              ...
              <Table aria-label="pay elements details table">
                <TableBody>
                  <TableRow>
                    ...
                    <TableCell align="left" sx={{ border: '1px solid black', padding: '0px 16px' }}>
