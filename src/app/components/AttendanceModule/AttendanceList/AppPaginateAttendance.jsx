      ...
      <StyledTable>
        <TableHead>
          <TableRow>
            ...
            <TableCell align="left">Calender Date</TableCell>
            <TableCell align="left">Daily Attendance Status</TableCell>
            ...
            data
              ...
              .map((attendance, index) => (
                <TableRow key={index}>
                  ...
                  <TableCell align="left">{attendance.user_status}</TableCell>
                  <TableCell align="left">{attendance.action}</TableCell>
                  <TableCell align="left">{attendance.calendar_date}</TableCell>
                  <TableCell align="left">{attendance.daily_attendance_status}</TableCell>
                  <TableCell align="left">{attendance.team_name}</TableCell>
                </TableRow>
              ))
          )}
        </TableBody>
